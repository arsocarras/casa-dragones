...
acv_ty      = base["% ACV (Max)"].mean()
acv_ly      = base["% ACV (Max) YA"].mean()
...
# ══════════════════════════════════════════════════════════════════════════════
# CHART 5 — Avg EQ Price vs TDP
# ══════════════════════════════════════════════════════════════════════════════
st.markdown("### Chart 5 — Avg EQ Price & TDP: TY vs LY")
st.markdown("<div style='height:6px'></div>", unsafe_allow_html=True)
...
fig5.update_layout(
    ...
    yaxis2=dict(tickformat=",.0f", gridcolor="rgba(0,0,0,0)", zeroline=False,
